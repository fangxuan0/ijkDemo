...
@interface SWHCaptureViewController ()<AVCaptureVideoDataOutputSampleBufferDelegate,AVCaptureAudioDataOutputSampleBufferDelegate>
...
@implementation SWHCaptureViewController
...
- (void)viewDidLoad {
    ...
    UIButton *changeBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, 0, 80, 30)];
    [changeBtn setTitle:@"切换摄像头" forState:UIControlStateNormal];
    changeBtn.titleLabel.font = [UIFont systemFontOfSize:14.0];
    changeBtn.titleEdgeInsets = UIEdgeInsetsMake(0, 20, 0, -15);
    [changeBtn addTarget:self action:@selector(changeBtnClick) forControlEvents:UIControlEventTouchUpInside];
    UIBarButtonItem *rightItem = [[UIBarButtonItem alloc] initWithCustomView:changeBtn];
